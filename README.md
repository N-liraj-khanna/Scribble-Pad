# Welcome to Scribble Pad 👋

An application using Node JS and react with sockets.io allows you to draw whats on your mind and share it in realtime with the  people connected to you, virtually. 

Basically, A Simple Clone of Google's Jam-board.
